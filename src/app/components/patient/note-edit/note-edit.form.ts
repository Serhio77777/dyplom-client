...
import NoteEditFormModel from './note-edit.model';
import { format } from 'date-fns';

/*
  ReactiveForm structure class
*/
export default class NoteEditForm {
  private formBuilder: FormBuilder;
  public formGroup: FormGroup;
  public model: NoteEditFormModel;

  constructor(model: NoteEditFormModel) {
  ...
  // get group value
  get formData(): NoteEditFormModel {
