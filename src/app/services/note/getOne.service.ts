...
export class GetOneNote {
  ...
  constructor(
    ...
    this.options = {
      url: `/note/${localStorage.getItem('patientId')}`,
      handlers: {
  ...
  public success(user: GetCredentialsResponse): void {
    this.bus.publish(this.events.received.note.one.success, user);
  }
  ...
  public subscribe(): void {
    this.bus.subscribe(this.events.requested.data.note.one, this.request.bind(this));
  }
}